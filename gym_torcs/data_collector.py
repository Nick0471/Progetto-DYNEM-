...
BRAKE_THRESHOLD = 0.35  # Angle threshold for braking. Lower values brake earlier.
GEAR_SPEEDS = [0, 80, 120, 160, 220, 270]  # Speed thresholds for gear shifting.
ENABLE_TRACTION_CONTROL = True  # Toggle traction control system.
# =================================================================

SAFE_GENTLE_CORNER_SPEED = 160 # Safe speed in km/h for a gentle corner
SAFE_SHARP_CORNER_SPEED = 75 # Safe speed in km/h for a sharp corner
TARGET_STRAIGHT_SPEED = 290 # Target speed in km/h for distances deemed a straight (We can safely acheieve a high speed)
CORNER_READING = 5 # Distance that signifies that the car is in a corner
SLOW_DOWN_DISTANCE = 110 # Distance that signifies a corner is approaching
STRAIGHT_DISTANCE = 120 # Distance of a 'straight' that we can safely achieve a high speed
BRAKING_INTENSITY = 0.95 # How much we brake by [0-1.0]
STEERING_EFFECT = 2.0 # How much the steering effects the acceleration
