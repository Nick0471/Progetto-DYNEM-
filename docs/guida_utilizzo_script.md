...
- Divide in train/test set (mantenendo i giri interi per evitare data leakage)
...
| Latenza > 10ms | Modello troppo complesso o hardware limitato | Prova a ridurre k|
